...
static func create_save_data(furniture: PlaceableFurniture):
	var resource: RFurnitureSaveData = RFurnitureSaveData.new()
	var packed_scene: PackedScene = PackedScene.new()
	#packed_scene.pack(furniture)
	#resource.packed_scene = packed_scene
	resource.item_data = furniture.furniture_data
	resource.global_pos = furniture.global_position
	resource.primary_tile = furniture.primary_tile
	resource.occupied_tiles = furniture.occupied_tiles
